...
require('lazy').setup({
  ...
  },
  {
    ...
    lazy = false, -- AS PER README: "This plugin does not support lazy-loading."
    build = ':TSUpdate',
    config = function()
      local ts = require 'nvim-treesitter'

      ts.setup {
        -- AS PER README: This is where your compiled brains (.so files) live
        install_dir = vim.fn.stdpath 'data' .. '/site',
      }

      -- AS PER README: Highlighting is NOT enabled automatically anymore.
      -- We tell Neovim to start the engine when you open specific file types.
      vim.api.nvim_create_autocmd('FileType', {
        pattern = { 'lua', 'ruby', 'python', 'markdown', 'vim', 'bash' },
        callback = function()
